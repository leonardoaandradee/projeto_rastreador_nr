...
#include "secrets.h" // 🔥 Puxa os certificados, chaves e o DEVICE_ID gerados pelo script

// --- DADOS DA REDE DA APRESENTAÇÃO ---
const char* ssid = "Redmi Note 13";
const char* password = "12345678";

const char* mqtt_server = "10.16.29.150"; 
...
void setup() {
  ...
  // 🛡️ SEGURANÇA MÁXIMA (mTLS Autêntico) 🛡️
...
void loop() {
  ...
  if (tempoAtual - tempoUltimaLeitura >= intervaloLeitura) {
    ...
    float lat_envio = -33.868801;  
    float lng_envio = 151.209305; 
